...
namespace pan.kaikj.wxsupermarket.AdoDal
{
    ...
    public class OrdermainDal 
    {
        ...
        ///// <returns></returns>
        //public bool AddOrder(List<Mordersmain> model)
        //{

        //    //// sql语句
        //    string sql = "INSERT INTO ordersmain(orderGroupId,userId,userName,productId,productname,productformat,origPrice,sellPrice,totalPrice，freight,payType,payTypeDesc,requireDeliveryTime,orderState,orderStateDesc,mailAddress,isDelete,isEffective,great_time,modify_time) VALUES";
        ...
        //    {
        //        sql = string.Format("{0} (?orderGroupId{1},?userId{1},?userName{1},?productId{1},?productname{1},?productformat{1},?buyNum{1},?origPrice{1},?sellPrice{1},?totalPrice{1},?freight{1},?payType{1},?payTypeDesc{1},?requireDeliveryTime{1},?orderState{1},?orderStateDesc{1},?mailAddress{1},?isDelete{1},?isEffective{1},?great_time{1},?modify_time{1}),", sql, i);
        ...
        //        parameter = new MySqlParameter("?productId" + i, MySqlDbType.VarChar, 500);
        //        parameter.Value = model[i].productId;
        //        parameterList.Add(parameter);

        //        parameter = new MySqlParameter("?productname" + i, MySqlDbType.VarChar, 1000);
        ...
        ///// <returns></returns>
        //public bool UpdateOrderState(string orderGroupId, int orderState)
        //{

        //    string orderStateDesc = this.GetOrserStateDesc(orderState);
        //    string sql = "update ordersmain set orderState=?orderState,orderStateDesc=?orderStateDesc,modify_time=?modify_time ";
        ...
        ///// <param name="orderid"></param>
        ///// <returns></returns>
        //public Mordersmain GetOrderInfoById(string orderGroupId)
        //{
        //    string sql = " SELECT orderGroupId,userId,userName,productId,productname,productformat,origPrice,sellPrice,totalPrice，freight,payType,payTypeDesc,requireDeliveryTime,orderState,orderStateDesc,mailAddress,isDelete,isEffective,great_time,modify_time  FROM ordersmain where orderGroupId=?orderGroupId";
        ...
        //            {
        //                Mordersmain model = new Mordersmain();
