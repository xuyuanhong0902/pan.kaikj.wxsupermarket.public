...
namespace pan.kaikj.wxsupermarket.AdoSqlHelper
{
    ...
    /// ADO.NET-------底层的数据操作
    /// </summary>
    public static class PKMySqlHelper
    {
        /// <summary>
        /// 连接语句
        /// </summary>
        ///  public static string connectionString = ConfigurationManager.AppSettings["SqlString"];
        public static string connectionString = ConfigurationManager.AppSettings["MySqlString"];

        #region 执行一个查询，返回查询的结果集+ExecuteDataTable(string sql, CommandType commandtype, MySqlParameter[] parameters)
        ...
        {
            DataSet data = new DataSet();  //实例化datatable,用于装载查询的结果集
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                using (MySqlCommand cmd = new MySqlCommand(sql, conn))
                {
        ...
        #region 返回一个MySqlDataReader对象。

        public static MySqlDataReader ExecuteReader(string sql)
        {
            return ExecuteReader(sql, CommandType.Text, null);
        }
        public static MySqlDataReader ExecuteReader(string sql, CommandType commandType)
        {
            return ExecuteReader(sql, commandType, null);
        }

        /// <summary>
        /// 返回一个MySqlDataReader，从 SQL Server 数据库读取行的只进流的方式
        /// </summary>
        /// <returns></returns>
        ...
        /// </summary>
        /// <returns></returns>
        public static MySqlDataReader ExecuteReader(string sql, CommandType commandType, MySqlParameter[] parameters)
        {
            MySqlConnection conn = new MySqlConnection(connectionString);
            MySqlCommand cmd = new MySqlCommand(sql, conn);
            if (parameters != null)
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public static object ExecuteScalar(string sql, CommandType commandType, MySqlParameter[] parameters)
        {
            MySqlConnection conn = new MySqlConnection(connectionString);
            MySqlCommand cmd = new MySqlCommand(sql, conn);
            cmd.CommandType = commandType;
        ...
        /// <param name="parameters">Transact-SQL语句或者存储过程的参数数组</param>
        /// <returns></returns>
        public static int ExecuteNonQuery(string sql, CommandType commandType, MySqlParameter[] parameters)
        {
            MySqlConnection conn = new MySqlConnection(connectionString);
            MySqlCommand cmd = new MySqlCommand(sql, conn);
            cmd.CommandType = commandType;
        ...
        /// <summary>
        ///   将MySqlDataReader转换为Model实体
        /// </summary>
        /// <typeparam name="T">实例类名</typeparam>
        /// <param name="dr">Reader对象</param>
        /// <returns>实体对象</returns>
        public static T ReaderToModel<T>(MySqlDataReader dr)
        {
            try
            {
                using (dr)
        ...
        /// <param name="dr">Reader对象</param>
        /// <returns>实体对象</returns>
        public static List<T> ReaderToModelList<T>(MySqlDataReader dr)
        {
            try
            {
                using (dr)
