...
function initBotom(pagIndex) {
    ...
    var html = ' <a  href="/market/Index" class="ontCount"><i style = "background-position:' + (pagIndex == 1 ? "-120px -46px" : "-84px -46px")+';" ></i ><span>首页</span></a >\
        <a  href="/market/takeout" class="ontCount"><i style="background-position:' + (pagIndex == 2 ? "-49px -120px" : "-12px -120px") +';"></i><span>购物车</span></a>\
        <a  href="/market/orderList" class="ontCount"><i style="background-position:' + (pagIndex == 3 ? "-120px -120px" : "-83px -120px") +';"></i><span>我的订单</span></a>';
    $("#botCount").html(html);
}
