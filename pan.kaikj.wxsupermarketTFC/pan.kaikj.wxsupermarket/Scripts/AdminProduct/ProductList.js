...
app.controller("myContro", function ($scope) {
    ...
    function GetAndShowData() {
        $.ajax({
            ...
            data: "pagIndex=" + pagIndex + "&acount=" + $scope.condition.acount + "&productname=" + $scope.condition.productname + "&shelfstate=" + $scope.condition.shelfstate,//将该表单序列化
